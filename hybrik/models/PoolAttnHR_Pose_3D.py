...
class PoolAttnHR_Pose_3D(nn.Module):
    ...
    def forward(self, x):
        ...
        bs, C, T, H, W = x_feature.shape

        x_feature = x_feature.permute(0,2,1,3,4).contiguous().view(bs*T, C, H, W)
        ...
        _, joints, new_H, new_W = hm_2d_pred.shape
        ...
        _, pose_joints, d = pose_3d_pred.shape

        pose_3d_pred = pose_3d_pred.view((bs, T, pose_joints, d)) 
        hm_2d_pred = hm_2d_pred.view(bs, T, joints, new_H, new_W)
